...
class GeneralUses(softest.TestCase):
    ...
    def login_fail(self, username, password):
        ...
        error_msg = "//p[contains(text(), 'These credentials do not match our records.')]"
        wait.until(EC.presence_of_element_located((By.XPATH, error_msg)))
        self.driver.save_screenshot("evidence/logging_fail.png")
